[![Build Status](https://img.shields.io/github/actions/workflow/status/hekmekk/git-team/verify.yml?branch=main&logo=github&style=for-the-badge)](https://github.com/hekmekk/git-team/actions)
