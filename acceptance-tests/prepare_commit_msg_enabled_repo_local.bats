...
REPO_PATH=/tmp/repo/prepare-commit-msg-enabled
...
@test "prepare-commit-msg: git-team enabled: repo-local - message" {
...
@test "prepare-commit-msg: git-team enabled: repo-local - squash" {
