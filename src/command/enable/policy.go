...
func installHooks(deps Dependencies, hooksDir string) error {
	...
	prepareCommitMsgGitTeamContent := getPrepareCommitMsgGitTeamContent()
	...
	if err := deps.WriteHookFile(filepath.Join(hooksDir, "prepare-commit-msg-git-team.sh"), []byte(prepareCommitMsgGitTeamContent), 0755); err != nil {
		return err
	}
...
func getProxyHookFileContent() string {
	return `## generated by git-team, do not modify ##
#!/bin/sh
...
func getPrepareCommitMsgGitTeamContent() string {
	return `## generated by git-team, do not modify ##
#!/bin/sh
